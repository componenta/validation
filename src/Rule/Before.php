...
/**
 * Before rule: date must be before a given date.
 *
 ...
 *
 * Example:
 *   new Before('2024-12-31')
 *   new Before('field:end_date')
 *   new Before('today')
 */
...
{
    public const string INVALID_DATE_MESSAGE_ID = 'validation.before.invalid_date';
    public const string NOT_BEFORE_MESSAGE_ID = 'validation.before.not_before';
     ...
     * @param int $graceMinutes Allow the value to exceed the reference by this many minutes.
     */
    ...
    /**
     * Quick check if value is before reference date.
     *
    ...
    public function validate(mixed $value, ContextInterface $context): true|ErrorMessageCollectorInterface
    {
        ...
        $collector->add($path, new ErrorMessage($context, self::NOT_BEFORE_MESSAGE_ID, [
    ...
    private function applyGraceWindow(DateTimeImmutable $referenceDate): DateTimeImmutable
    {
        ...
        return $referenceDate->add(new DateInterval(sprintf('PT%dM', $this->graceMinutes)));
    }
    ...
    public static function getMessages(): array
    {
        return [
            ...
            self::NOT_BEFORE_MESSAGE_ID => 'The date must be before:or_equal :date.',
        ];
    }
}
