...
/**
 * Positive rule: value must be a positive number.
 *
 * By default, zero is not considered positive.
 */

#[Attribute(Attribute::TARGET_PROPERTY | Attribute::TARGET_PARAMETER)]
final class Positive implements RuleInterface
{
    public const string NOT_NUMERIC_MESSAGE_ID = 'validation.positive.not_numeric';
    public const string NOT_POSITIVE_MESSAGE_ID = 'validation.positive.not_positive';
    ...
    public function validate(mixed $value, ContextInterface $context): true|ErrorMessageCollectorInterface
    {
        ...
        if (!$isValid) {
            $collector->add($path, new ErrorMessage($context, self::NOT_POSITIVE_MESSAGE_ID, [
                'actual' => $numericValue,
    ...
    public static function getMessages(): array
    {
        return [
            ...
            self::NOT_POSITIVE_MESSAGE_ID => 'The value must be positive.',
        ];
    }
}
