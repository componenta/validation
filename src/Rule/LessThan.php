...
/**
 * LessThan rule: value must be less than another field's value.
 *
 * Supports numbers and dates.
 *
 * Example:
 *   new LessThan('max_price') // min_price must be < max_price
 *   new LessThan('end_date') // start_date must be < end_date
 */

#[Attribute(Attribute::TARGET_PROPERTY | Attribute::TARGET_PARAMETER)]
final class LessThan implements RuleInterface
{
    public const string NOT_COMPARABLE_MESSAGE_ID = 'validation.less_than.not_comparable';
    public const string NOT_LESS_MESSAGE_ID = 'validation.less_than.not_less';
    ...
    /**
     * Quick check if value is less than other.
     * Supports numbers and dates.
     */
    ...
    public function validate(mixed $value, ContextInterface $context): true|ErrorMessageCollectorInterface
    {
        ...
        if ($valueDate !== null && $otherDate !== null) {
            ...
            $collector->add($path, new ErrorMessage($context, self::NOT_LESS_MESSAGE_ID, [
    ...
    public static function getMessages(): array
    {
        return [
            ...
            self::NOT_LESS_MESSAGE_ID => 'The value must be less than :or_equal :other.',
        ];
    }
}
